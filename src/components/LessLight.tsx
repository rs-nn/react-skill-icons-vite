...
const LessLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="#2E4F82" />
        <stop offset={1} stopColor="#182E4D" />
      </linearGradient>
    </defs>
  </svg>
);
