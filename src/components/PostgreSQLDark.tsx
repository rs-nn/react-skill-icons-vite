...
const PostgreSQLDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeWidth={5.034}
      d="M181.613 144.664s1.407 6.891 21.797 2.686c8.909-1.842 3.544 5.161-5.484 9.352-7.411 3.445-24.033 4.324-24.307-.422-.703-12.27 8.747-8.543 8.065-11.616-.619-2.77-4.852-5.484-7.636-12.262-2.44-5.907-33.469-51.258 8.606-44.53 1.547-.316-10.969-40.077-50.344-40.654s-38.13 48.41-38.13 48.41"
    />
    <path
      stroke="#fff"
      strokeLinejoin="round"
      strokeWidth={5.034}
      d="M117.08 148.869c-5.484 6.131-3.867 7.207-14.835 9.464-11.096 2.285-4.57 6.356-.324 7.425 5.161 1.294 17.1 3.122 25.172-8.178 2.461-3.445-.014-8.929-3.389-10.321-1.631-.675-3.811-1.519-6.609 1.617z"
    />
    <path
      stroke="#fff"
      strokeLinecap="round"
    ...
    <path
      ...
      stroke="#fff"
      strokeWidth={1.68}
      d="M110.577 95.27c-.12.822 1.511 3.023 3.628 3.318 2.116.296 3.923-1.42 4.043-2.25.119-.83-1.512-1.73-3.628-2.025s-3.938.14-4.043.956Z"
    />
    <path
      fill="#fff"
      stroke="#fff"
      strokeWidth={0.837}
      d="M175.011 93.59c.112.822-1.512 3.022-3.628 3.318-2.117.295-3.938-1.42-4.043-2.25-.106-.83 1.512-1.73 3.628-2.025s3.937.14 4.043.956Z"
    />
    <path
      stroke="#fff"
      strokeLinecap="round"
