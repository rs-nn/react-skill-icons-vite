...
const GCPLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#EA4335"
      d="m161.009 92.39 17.385-17.386 1.159-7.32c-31.68-28.807-82.04-25.54-110.6 6.816-7.932 8.986-13.817 20.19-16.955 31.76l6.226-.878 34.77-5.733 2.684-2.745c15.466-16.986 41.617-19.272 59.475-4.82z"
    />
    <path
      fill="#4285F4"
    ...
    <path
      fill="#34A853"
      d="M84.149 208.778h43.432v-34.77H84.149a21.3 21.3 0 0 1-8.906-1.952l-6.161 1.891-17.507 17.385-1.525 5.917c9.818 7.413 21.796 11.582 34.099 11.529"
    />
    <path
      fill="#FBBC05"
