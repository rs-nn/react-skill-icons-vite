...
const Astro = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <defs>
      ...
      >
        <stop offset={0.193} stopColor="#FCB3B2" />
        <stop offset={1} stopColor="#C587EE" />
      </linearGradient>
      <linearGradient
        id="prefix__b"
        x1={189.089}
