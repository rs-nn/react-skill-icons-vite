...
const VSCodiumLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="#62A0EA" />
        <stop offset={1} stopColor="#1A5FB4" />
      </linearGradient>
    </defs>
  </svg>
);
export { VSCodiumLight };
